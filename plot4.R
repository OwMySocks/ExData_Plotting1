...
plot(data$DateTimeFormat,data$Voltage,type="l",ylab="Voltage",xlab="datetime")
...
plot(data$DateTimeFormat,data$Global_reactive_power,type="l",xlab="datetime",ylab="Global_reactive_power")
dev.off()
